...
void main() {
  test('finds cover.jpg next to the files', () {
    ...
    expect(FolderCover.find(dir.path)?.path, p.join(dir.path, 'cover.jpg'));
  });

  test('ignores empty files and unrelated images', () {
    ...
    expect(FolderCover.find(dir.path), equals(null));
  });
}
