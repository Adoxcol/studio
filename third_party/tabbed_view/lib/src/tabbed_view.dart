...
class TabbedView extends StatefulWidget {
  ...
  /// Wraps only the tab strip, including its unused space (not panel content).
  final Widget Function(BuildContext context, Widget child)? tabsAreaBuilder;
...
class _TabbedViewState extends State<TabbedView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (tabsAreaVisible) {
      ...
      if (widget.tabsAreaBuilder != null) {
        tabArea = widget.tabsAreaBuilder!(context, tabArea);
      }
